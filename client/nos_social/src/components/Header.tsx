...
function Header() {
    ...
    return (
        <header className="w-full bg-white flex justify-between items-center py-2 px-4 shadow-sm">
            <Link className="font-bold text-sky-600 text-lg" href='/'>Nós Social</Link>
