    ...
    return (
        <section className="lg:flex p-4 lg:py-16 lg:px-72 bg-blue-800 text-white">
            <div>
                ...
                <p className="text-base lg:text-2xl pb-12 lg:pr-28">Junte-se a nós nesta jornada de solidariedade e impacto social. Vamos trabalhar juntos para construir um futuro melhor para todos.</p>
                <button className="bg-white hover:bg-slate-100 py-4 px-6 font-bold text-gray-900 rounded-lg text-lg uppercase">
